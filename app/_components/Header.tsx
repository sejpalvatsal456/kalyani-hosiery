...
export default function Header(
  ...
  return (
    <div
        className={'h-10 w-[100vw] flex justify-between items-center bg-[linear-gradient(90deg,_#efe0c9ff_,_#efe0c9aa)]' + ( visibility ? "" : " hidden" )}
    >
      ...
      <h1 className='text-sm font-medium justify-self-right'>Welcome to our store</h1>
      <h1></h1>
    </div>
  )
}
