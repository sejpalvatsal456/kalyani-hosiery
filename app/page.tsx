...
const productDataListFromApi: DisplayProductType[] = [
  {
    _id: "1",
    category: {_id: "1", name:"Men"},
    subcategory: { _id: "2", categoryId: "1", name: "T Shirt" },
    thumbnail: "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?fm=jpg&q=60&w=3000&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NHx8dCUyMHNoaXJ0fGVufDB8fDB8fHww",
    pricing: {
      mrp: 250,
      sellingPrice: 200
    },
  ...
  },
  {
    _id: "2",
    category: {_id: "1", name:"Men"},
    subcategory: { _id: "3", categoryId: "1", name: "Pants" },
